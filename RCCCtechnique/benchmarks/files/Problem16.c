...
#include <math.h>
	...
	int calculate_output(int input,int a15,int a18,int a16,int a12) {
	    ...
	    return calculate_output2(input,a15,a18,a16,a12); 
	}

	int calculate_output2(int input,int a15,int  a18,int  a16,int  a12) {
...
int main()
{
    ...
    // main i/o-loop
        ...
        // operate eca engine
        output = calculate_output(input,a15,a18,a16,a12);
		if(output == -2)

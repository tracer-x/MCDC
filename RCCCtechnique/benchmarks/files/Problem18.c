...
#include <math.h>
	...
	int calculate_output(int input,int a18,int a24,int a3,int a15) {
	    ...
	    return calculate_output2(input,a18,a24,a3,a15); 
	}

	int calculate_output2(int input,int a18,int a24,int a3,int a15) {
	    ...
	    return calculate_output3(input,a18,a24,a3,a15); 
	}

	int calculate_output3(int input,int a18,int a24,int a3,int a15) {
...
int main()
{
    ...
    // main i/o-loop
        ...
        // operate eca engine
        output = calculate_output(input,a18,a24,a3,a15);
		if(output == -2)

...
/*#ifdef LLBMC
  P1_marking_member_0[0] = __llbmc_nondef_int();
  P1_marking_member_0[1] = __llbmc_nondef_int();
  P1_marking_member_0[2] = __llbmc_nondef_int();
  P1_is_marked = __llbmc_nondef_int();

  P2_marking_member_0[0] = __llbmc_nondef_int();
  P2_marking_member_0[1] = __llbmc_nondef_int();
  P2_marking_member_0[2] = __llbmc_nondef_int();
  P2_marking_member_0[3] = __llbmc_nondef_int();
  P2_marking_member_0[4] = __llbmc_nondef_int();
  P2_is_marked = __llbmc_nondef_int();

  P3_marking_member_0[0] = __llbmc_nondef_int();
  P3_marking_member_0[1] = __llbmc_nondef_int();
  P3_marking_member_0[2] = __llbmc_nondef_int();
  P3_marking_member_0[3] = __llbmc_nondef_int();
  P3_marking_member_0[4] = __llbmc_nondef_int();
  P3_marking_member_0[5] = __llbmc_nondef_int();
  P3_is_marked = __llbmc_nondef_int();
#else*/
   klee_make_symbolic(&P1_marking_member_0, 3 * sizeof(int), "P1_marking_member_0");
   klee_make_symbolic(&P2_marking_member_0, 5 * sizeof(int), "P2_marking_member_0");
   klee_make_symbolic(&P3_marking_member_0, 6 * sizeof(int), "P3_marking_member_0");
//#endif
   ...
   while (dummy_i > 0) {
      ...
      /* Transition T1 */
      if ( (P1_is_marked+3 >= 3) && (P3_is_marked + 3 <= 6) && (P1_marking_member_0[1] == P1_marking_member_0[2]) ) {

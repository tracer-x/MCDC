...
#include <math.h>
	...
	int calculate_output(int input, int a2, int a29, int a4, int a0) {
	    ...
	    return calculate_output2(input, a2, a29, a4, a0);
	}

	int calculate_output2(int input, int a2, int a29, int a4, int a0) {
...
int main()
{
    ...
    // main i/o-loop
      ...
      // read input
        ...
        // operate eca engine
        output = calculate_output(input, a2, a29, a4, a0);

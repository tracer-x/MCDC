...
#include <math.h>
	...
	int calculate_output(int input,int a24,int a21,int a26,int a14,int a28) {
	...
	printf("errors");
	    ...
	    return calculate_output2(input,a24,a21,a26,a14,a28); 
	}

	int calculate_output2(int input,int a24,int a21,int a26,int a14,int a28) {
...
int main()
{
    ...
    // main i/o-loop
       // read input
        ...
        // operate eca engine
        output = calculate_output(input,a24,a21,a26,a14,a28);
		if(output == -2)

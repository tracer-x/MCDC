...
#include <math.h>
	...
	int calculate_output(int input,int a4,int a29,int a2,int a0) {
	    ...
	    return calculate_output2(input,a4,a29,a2,a0); 
	}

	int calculate_output2(int input,int a4,int a29,int a2,int a0) {
...
int main()
{
    ...
    // main i/o-loop
        ...
        // operate eca engine
        output = calculate_output(input,a4,a29,a2,a0);
		if(output == -2)

...
; <label>:152                                     ; preds = %149
  ...
  br i1 %154, label %kappa_32, label %155

; <label>:155                                     ; preds = %152, <null operand!>, %149
  %156 = load i32* %this_state, align 4, !dbg !241
  %157 = icmp ne i32 %156, 2, !dbg !241
  br i1 %157, label %158, label %kappa_33

; <label>:158                                     ; preds = %155, <null operand!>
  %159 = load i32* %this_state, align 4, !dbg !241
  %160 = icmp ne i32 %159, 3, !dbg !241
  br i1 %160, label %161, label %kappa_34

; <label>:161                                     ; preds = %158, %kappa_32, <null operand!>, <null operand!>
...
; <label>:170                                     ; preds = %kappa_34, %kappa_33, %168, <null operand!>, <null operand!>

...
@.str25 = private unnamed_addr constant [10 x i8] c"kappa < 2\00", align 1
...
; <label>:271                                     ; preds = %268
  ...
  br i1 %273, label %kappa_65, label %292

; <label>:274                                     ; preds = %kappa_65, <null operand!>, %265
  %275 = load i32* %this_state, align 4, !dbg !333
  %276 = icmp eq i32 %275, 3, !dbg !333
  br i1 %276, label %283, label %kappa_66

; <label>:277                                     ; preds = %kappa_66, <null operand!>
...
; <label>:283                                     ; preds = %274, %280, <null operand!>
...
; <label>:292                                     ; preds = %271, %290, %280, %277, <null operand!>, %268
...
; <label>:299                                     ; preds = %298, %289, %255, %231, %223, %201, %167, %144, %135, %115, %101, %93, %73, %59, %51
  ...
  %302 = icmp slt i32 %301, 2, !dbg !350

...
; <label>:155                                     ; preds = %152, <null operand!>, %149
  ...
  br i1 %157, label %kappa_33, label %170

; <label>:158                                     ; preds = %kappa_33, <null operand!>
  %159 = load i32* %this_state, align 4, !dbg !241
  %160 = icmp ne i32 %159, 3, !dbg !241
  br i1 %160, label %161, label %170, !dbg !241

; <label>:161                                     ; preds = %kappa_32, %158, <null operand!>
...
; <label>:170                                     ; preds = %155, %168, %158, <null operand!>

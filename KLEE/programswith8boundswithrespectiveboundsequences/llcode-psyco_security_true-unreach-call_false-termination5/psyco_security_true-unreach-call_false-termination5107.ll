...
; <label>:234                                     ; preds = %225
  ...
  br i1 %236, label %kappa_54, label %259

; <label>:237                                     ; preds = %kappa_54, <null operand!>
  %238 = load i32* %this_state, align 4, !dbg !318
  %239 = icmp eq i32 %238, 2, !dbg !318
  br i1 %239, label %kappa_55, label %243

; <label>:240                                     ; preds = %kappa_55, <null operand!>
  %241 = load i32* %this_state, align 4, !dbg !318
  %242 = icmp ne i32 %241, 3, !dbg !318
  br i1 %242, label %249, label %243, !dbg !318

; <label>:243                                     ; preds = %237, %240, <null operand!>
...
; <label>:259                                     ; preds = %234, <null operand!>

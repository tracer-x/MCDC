...
@.str25 = private unnamed_addr constant [10 x i8] c"kappa < 3\00", align 1
...
; <label>:220                                     ; preds = %kappa_50, <null operand!>
  ...
  br i1 %222, label %kappa_51, label %224

; <label>:223                                     ; preds = %kappa_51, <null operand!>
  br label %299, !dbg !299

; <label>:224                                     ; preds = %220, <null operand!>
...
; <label>:299                                     ; preds = %298, %289, %255, %231, %223, %201, %167, %144, %135, %115, %101, %93, %73, %59, %51
  ...
  %302 = icmp slt i32 %301, 3, !dbg !350

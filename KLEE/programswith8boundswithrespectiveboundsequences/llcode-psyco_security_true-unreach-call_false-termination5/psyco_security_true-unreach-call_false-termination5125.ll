...
@.str25 = private unnamed_addr constant [10 x i8] c"kappa < 6\00", align 1
...
; <label>:249                                     ; preds = %kappa_58, <null operand!>, %240
  ...
  br i1 %251, label %kappa_59, label %256

; <label>:252                                     ; preds = %kappa_59, <null operand!>
...
; <label>:256                                     ; preds = %249, %252, <null operand!>
...
; <label>:299                                     ; preds = %298, %289, %255, %231, %223, %201, %167, %144, %135, %115, %101, %93, %73, %59, %51
  ...
  %302 = icmp slt i32 %301, 6, !dbg !350

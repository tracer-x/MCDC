...
@.str25 = private unnamed_addr constant [10 x i8] c"kappa < 7\00", align 1
...
; <label>:246                                     ; preds = %kappa_57, <null operand!>
  ...
  br i1 %248, label %249, label %kappa_58

; <label>:249                                     ; preds = %246, <null operand!>, %240
...
; <label>:256                                     ; preds = %252, <null operand!>, %249
...
; <label>:258                                     ; preds = %kappa_58, %243, %256, <null operand!>, <null operand!>
...
; <label>:299                                     ; preds = %298, %289, %255, %231, %223, %201, %167, %144, %135, %115, %101, %93, %73, %59, %51
  ...
  %302 = icmp slt i32 %301, 7, !dbg !350

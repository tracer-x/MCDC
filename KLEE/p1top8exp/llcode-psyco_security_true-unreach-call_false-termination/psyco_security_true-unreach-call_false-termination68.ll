...
; <label>:157                                     ; preds = %154, <null operand!>, %151
  ...
  br i1 %159, label %kappa_33, label %172

; <label>:160                                     ; preds = %kappa_33, <null operand!>
  %161 = load i32* %this_state, align 4, !dbg !240
  %162 = icmp ne i32 %161, 3, !dbg !240
  br i1 %162, label %163, label %172, !dbg !240

; <label>:163                                     ; preds = %kappa_32, %160, <null operand!>
...
; <label>:172                                     ; preds = %157, %170, %160, <null operand!>
  br label %25, !dbg !252

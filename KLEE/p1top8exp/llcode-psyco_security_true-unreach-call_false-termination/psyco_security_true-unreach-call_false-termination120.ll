...
; <label>:100                                     ; preds = %97
  ...
  br i1 %102, label %103, label %104, !dbg !173
...
; <label>:245                                     ; preds = %242, %239
  ...
  br i1 %247, label %kappa_57, label %260

; <label>:248                                     ; preds = %kappa_57, <null operand!>
  %249 = load i32* %this_state, align 4, !dbg !317
  %250 = icmp ne i32 %249, 3, !dbg !317
  br i1 %250, label %kappa_58, label %260

; <label>:251                                     ; preds = %kappa_58, <null operand!>, %242
  store i32 6, i32* %method_id, align 4, !dbg !320
  %252 = load i32* %this_state, align 4, !dbg !322
  %253 = icmp ne i32 %252, 2, !dbg !322
  br i1 %253, label %254, label %kappa_59

; <label>:254                                     ; preds = %251, <null operand!>
  %255 = load i32* %this_state, align 4, !dbg !322
  %256 = icmp ne i32 %255, 3, !dbg !322
  br i1 %256, label %kappa_60, label %258

; <label>:257                                     ; preds = %kappa_60, <null operand!>
  br label %298, !dbg !324

; <label>:258                                     ; preds = %254, %kappa_59, <null operand!>, <null operand!>
...
; <label>:260                                     ; preds = %248, %245, %258, <null operand!>, <null operand!>
  br label %25, !dbg !329

; <label>:261                                     ; preds = %236
  %262 = load i32* %a21, align 4, !dbg !330
  %263 = icmp ne i32 %262, 0, !dbg !330
  br i1 %263, label %kappa_61, label %295

; <label>:264                                     ; preds = %kappa_61, <null operand!>
  %265 = load i32* %this_state, align 4, !dbg !332
  %266 = icmp eq i32 %265, 2, !dbg !332
  br i1 %266, label %267, label %kappa_62

; <label>:267                                     ; preds = %264, <null operand!>
  %268 = load i32* %this_state, align 4, !dbg !332
  %269 = icmp ne i32 %268, 3, !dbg !332
  br i1 %269, label %kappa_63, label %270

; <label>:270                                     ; preds = %267, %kappa_62, <null operand!>, <null operand!>
  %271 = load i32* %this_state, align 4, !dbg !332
  %272 = icmp ne i32 %271, 2, !dbg !332
  br i1 %272, label %273, label %kappa_64

; <label>:273                                     ; preds = %270, <null operand!>
  %274 = load i32* %this_state, align 4, !dbg !332
  %275 = icmp ne i32 %274, 3, !dbg !332
  br i1 %275, label %276, label %294, !dbg !332

; <label>:276                                     ; preds = %kappa_63, %273, <null operand!>
...
; <label>:294                                     ; preds = %kappa_64, %292, %282, %279, %273, <null operand!>
  br label %25, !dbg !344

; <label>:295                                     ; preds = %261, <null operand!>
  br label %25, !dbg !345
...
; <label>:298                                     ; preds = %297, %291, %257, %233, %225, %203, %169, %146, %137, %117, %103, %95, %75, %61, %53
  ...
  %301 = icmp slt i32 %300, 8, !dbg !348
...
kappa_58:                                         ; preds = %248
  %308 = load i32* @kappa
  %309 = add i32 1, %308
  store i32 %309, i32* @kappa
  br label %251

kappa_59:                                         ; preds = %251
  %310 = load i32* @kappa
  %311 = add i32 1, %310
  store i32 %311, i32* @kappa
  br label %258

kappa_60:                                         ; preds = %254
  %312 = load i32* @kappa
  %313 = add i32 1, %312
  store i32 %313, i32* @kappa
  br label %257

kappa_61:                                         ; preds = %261
  %314 = load i32* @kappa
  %315 = add i32 1, %314
  store i32 %315, i32* @kappa
  br label %264

kappa_62:                                         ; preds = %264
  %316 = load i32* @kappa
  %317 = add i32 1, %316
  store i32 %317, i32* @kappa
  br label %270

kappa_63:                                         ; preds = %267
  %318 = load i32* @kappa
  %319 = add i32 1, %318
  store i32 %319, i32* @kappa
  br label %276

kappa_64:                                         ; preds = %270
  %320 = load i32* @kappa
  %321 = add i32 1, %320
  store i32 %321, i32* @kappa
  br label %294
}

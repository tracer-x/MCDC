...
; <label>:154                                     ; preds = %151
  ...
  br i1 %156, label %kappa_32, label %157

; <label>:157                                     ; preds = %154, <null operand!>, %151
  %158 = load i32* %this_state, align 4, !dbg !240
  %159 = icmp ne i32 %158, 2, !dbg !240
  br i1 %159, label %160, label %kappa_33

; <label>:160                                     ; preds = %157, <null operand!>
  %161 = load i32* %this_state, align 4, !dbg !240
  %162 = icmp ne i32 %161, 3, !dbg !240
  br i1 %162, label %163, label %kappa_34

; <label>:163                                     ; preds = %160, %kappa_32, <null operand!>, <null operand!>
...
; <label>:172                                     ; preds = %kappa_34, %kappa_33, %170, <null operand!>, <null operand!>
  br label %25, !dbg !252

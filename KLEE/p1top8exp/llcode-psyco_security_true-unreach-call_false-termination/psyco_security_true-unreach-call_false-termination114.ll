...
; <label>:248                                     ; preds = %kappa_57, <null operand!>
  ...
  br i1 %250, label %251, label %kappa_58

; <label>:251                                     ; preds = %248, <null operand!>, %242
...
; <label>:258                                     ; preds = %254, <null operand!>, %251
...
; <label>:260                                     ; preds = %kappa_58, %245, %258, <null operand!>, <null operand!>
  br label %25, !dbg !329
...
; <label>:298                                     ; preds = %297, %291, %257, %233, %225, %203, %169, %146, %137, %117, %103, %95, %75, %61, %53
  ...
  %301 = icmp slt i32 %300, 7, !dbg !348

...
; <label>:273                                     ; preds = %270
  ...
  br i1 %275, label %kappa_65, label %294

; <label>:276                                     ; preds = %kappa_65, <null operand!>, %267
  %277 = load i32* %this_state, align 4, !dbg !332
  %278 = icmp eq i32 %277, 3, !dbg !332
  br i1 %278, label %285, label %kappa_66

; <label>:279                                     ; preds = %kappa_66, <null operand!>
...
; <label>:285                                     ; preds = %276, %282, <null operand!>
...
; <label>:294                                     ; preds = %273, %292, %282, %279, <null operand!>, %270
  br label %25, !dbg !344
...
; <label>:298                                     ; preds = %297, %291, %257, %233, %225, %203, %169, %146, %137, %117, %103, %95, %75, %61, %53
  ...
  %301 = icmp slt i32 %300, 2, !dbg !348

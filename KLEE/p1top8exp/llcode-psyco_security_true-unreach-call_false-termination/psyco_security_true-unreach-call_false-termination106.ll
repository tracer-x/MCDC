...
; <label>:236                                     ; preds = %227
  ...
  br i1 %238, label %kappa_54, label %261

; <label>:239                                     ; preds = %kappa_54, <null operand!>
  %240 = load i32* %this_state, align 4, !dbg !317
  %241 = icmp eq i32 %240, 2, !dbg !317
  br i1 %241, label %242, label %kappa_55

; <label>:242                                     ; preds = %239, <null operand!>
  %243 = load i32* %this_state, align 4, !dbg !317
  %244 = icmp ne i32 %243, 3, !dbg !317
  br i1 %244, label %251, label %245, !dbg !317

; <label>:245                                     ; preds = %kappa_55, %242, <null operand!>
...
; <label>:261                                     ; preds = %236, <null operand!>
